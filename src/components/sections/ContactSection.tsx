      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex flex-col lg:flex-row gap-16">
          <div className="flex-1">
            <h2 className="text-4xl font-bold text-finance-blue mb-6">
              Get In Touch
            </h2>
              ...
              <button
                ...
                className={`w-full py-4 rounded-xl font-bold text-lg shadow-xl transition-all flex items-center justify-center gap-2 ${
                  isSubmitting
                    ...
                    : "gradient-blue text-white hover:scale-[1.02] shadow-finance-blue/20"
                }`}
              >
                {isSubmitting ? (
                  "Sending..."
          ...
          <div className="flex-1">
            <div className="bg-slate-50 p-8 rounded-3xl border border-slate-200 h-full">
              <h3 className="text-2xl font-bold text-finance-blue mb-8">
                Contact Information
              </h3>
              <div className="space-y-8">
                <div className="flex gap-4">
                  <div className="w-12 h-12 rounded-xl bg-white shadow-md flex items-center justify-center text-finance-blue flex-shrink-0">
                    <MapPin />
                  </div>
                  <div>
                    <h4 className="font-bold text-finance-blue mb-1">
                      Office Address
                    </h4>
                    <p className="text-slate-600 text-sm">
                      Office No. 717 7th Floor Gaur City Mall Sector 4 Greater
                      Noida West Link Road Nearby Gaur City Center Greater Noida
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600 text-sm">+91 97189 51505</p>
                  </div>
                </div>
                <div className="flex gap-4">
                  <div className="w-12 h-12 rounded-xl bg-white shadow-md flex items-center justify-center text-finance-blue flex-shrink-0">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600 text-sm">
                      loanexpertindiaa@gmail.com
                    </p>
                    <p className="text-slate-600 text-sm">
                      Arjunyadav@loanexpertindia.com
                    </p>
                    <p className="text-slate-600 text-sm">
                      Arjun.loanexperts@gmail.com
                    </p>
                  </div>
                </div>
              </div>
